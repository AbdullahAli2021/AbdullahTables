...
namespace AbdullahTables.Controllers
{
    ...
    {
        private readonly AbdullahTablesContext _context;

        public TablesController(AbdullahTablesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Color,Type,Price,Review")] Tables tables)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Color,Type,Price,Review")] Tables tables)
        {
            if (id != tables.Id)
            {
                return NotFound();
